              ...
              <Row>
                <FormItem label="审核状态" prop="checkStates">
                  <RadioGroup v-model="formItem.checkStates" type="button" size="small">
                    ...
                    <Radio label="2">已确认</Radio>
                    <Radio label="3">待确认</Radio>
                ...
                h('Button', {
                  ...
                  on: {
                    click: () => {
                      ...
                      this.$router.push({ name: 'lesson_confirmDetail', params: {id:id},query:{projectId:projectId}});
                    }
                  }
                }, '确认')
              ]);
